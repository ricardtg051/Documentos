    ...
    def cargar_interfaz_principal(self, modo="nuevo"):
        ...
        if modo == "buscar":
            ...
            def buscar_ahora():
                ...
                self.app.cargar_usuario_desde_busqueda(texto_buscado)
        ...
        self.app.crear_input(marco_izquierdo, "Nombre Completo", "nombre", placeholder="Ej: Leonardo David Moreno Bruce", val_type="letras")
        ...
        boton_word = ctk.CTkButton(marco_botones, text="📄 WORD", fg_color="#e67e22", height=45, command=self.app.generar_word_ui)
